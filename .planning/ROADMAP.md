...
Plans:
- [ ] 01-01: Flutter project scaffolding with Flame dependency and build verification
- [ ] 01-02: Flame GameWidget integration and game loop skeleton
...
- [ ] 02-05: Timing window tuning and difficulty feel calibration
...
Plans:
- [ ] 04-01: Screen shake system (on death, near-miss, combo milestones)
...
- [ ] 04-06: Background pulse effect synced to gameplay rhythm
...
Plans:
- [ ] 05-01: Audio engine setup (flame_audio or alternative, asset loading)
- [ ] 05-02: Core SFX — tap sound, dodge whoosh, death impact, restart chime
- [ ] 05-03: Ambient background pulse/music loop
- [ ] 05-04: Dynamic audio — combo escalation sounds, near-miss tension
...
- [ ] 06-05: Score history and stats tracking (games played, best combo, total dodges)
...
Plans:
- [ ] 07-01: Progression currency/XP system (earned through gameplay)
...
Plans:
- [ ] 08-01: Title/main menu screen with game branding and play button
- [ ] 08-02: Game over screen with score summary and retry/menu options
- [ ] 08-03: Settings screen (audio, selected shape/theme)
- [ ] 08-04: Screen transitions and navigation flow between all screens
- [ ] 08-05: Pause overlay during gameplay
- [ ] 08-06: First-time tutorial/onboarding (minimal — show tap instruction)
